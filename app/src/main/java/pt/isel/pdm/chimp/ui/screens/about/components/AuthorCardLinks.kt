    ...
    Row(
        ...
        if (linkedInUrl != null) {
            SocialLink(
                ...
                url = linkedInUrl, size = SocialLinkSize.LARGE,
                onOpenUrl = onOpenUrl, onSendMail = onSendMail
            )
        }
        if (githubUrl != null) {
            SocialLink(
                ...
                url = githubUrl, size = SocialLinkSize.LARGE,
                onOpenUrl = onOpenUrl, onSendMail = onSendMail
            )
        }
        if (mailUrl != null) {
            SocialLink(
                ...
                url = mailUrl, size = SocialLinkSize.LARGE,
                onOpenUrl = onOpenUrl, onSendMail = onSendMail
            )
        }
    }
