...
class EntityReferenceManagerTests {
    ...
    @Test
    fun set_message_should_update_the_message_flow() =
        runTest {
            // Act
    ...
    @Test
    fun set_channel_should_update_the_channel_flow() =
        runTest {
            // Act
    ...
    @Test
    fun set_user_should_update_the_user_flow() =
        runTest {
            // Act
    ...
    @Test
    fun set_invitation_should_update_the_invitation_flow() =
        runTest {
            // Act
    ...
    @Test
    fun message_flow_should_emit_null_when_message_is_cleared() =
        runTest {
            // Arrange
            entityReferenceManager.setMessage(testMessage)
    ...
    @Test
    fun channel_flow_should_emit_null_when_channel_is_cleared() =
        runTest {
            // Arrange
            entityReferenceManager.setChannel(testChannel)
    ...
    @Test
    fun user_flow_should_emit_null_when_user_is_cleared() =
        runTest {
            // Arrange
            entityReferenceManager.setUser(testUser)
    ...
    @Test
    fun invitation_flow_should_emit_null_when_invitation_is_cleared() =
        runTest {
            // Arrange
            entityReferenceManager.setInvitation(testInvitation)
